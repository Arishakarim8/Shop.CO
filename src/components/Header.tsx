...
export default function BrandName() {
  ...
  return (
          <div className='h-12 md:top-[62px] top-[54px] flex md:justify-around w-full bg-white justify-between items-center  w- [100%] overflow-hidden xl:right- xl:l eft-[66px] md:gap-2 lg:gap-10 '>
          <div className=' flex '
