...
export default function Navbar() {
    return (
        ...
        //     </div>
        // </div>
        <div className='w-full h-[34px] sm:h-[38px] py-[9px] px-[16px] sm:px-[50px] lg:px-[100px] xl:px-[200px] flex items-center justify-between sm:justify-center text-white bg-black fixed top-0 left-0 z-50'>
            <div className='flex items-center justify-center w-full sm:w-[301px] sm:h-[16px] sm:left-[30px] md:w-[351px] md:h-[19px] text-xs sm:text-[14px] md:leading-[18px]'>
                <h1 className='font-normal'>
                    Sign up and get 20% off to your first order.
                </h1>
