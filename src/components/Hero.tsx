...
export default function Hero(){
 ...
 <div className="bg-[#f2f0f1] w-[100%] max-w-[1400px]  flex flex-col md:flex-row justify-between items-start absolute mt-6 md:mt-0 h-[953px] top-[98px] md:h-[552] lg:h-[663px] md:top-[134px] overflow-hidden">
   <Image 
        src={MAIN_PICTURE} 
        alt="Main image" 
