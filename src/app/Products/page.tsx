...
/*
      <div className=' w-[50vh]  aspect-square h-[25vh] sm:w -[30vw] mb-28  sm:h -[30vw]  lg: mr- 5 rounded-[13.42px] md:w -[30vw] md:h -[30vw] lg:w -[22vw] lg:h -[22vw] absolut md:rounded-[20px]  bg-[#F0EEED]'>
        <Image src={image} alt={title} className="  w-[55vh] md:w-[65vw] aspect-square h- [25vh] sm :w- [30vw] sm :h- [28vw]  md:w- [ 30vw] md:h- [30vw] lg:w- [22vw] lg:h- [22vw] "/>
