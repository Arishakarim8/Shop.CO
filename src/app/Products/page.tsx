...
const Pr: React.FC<ProductDiscountCardProps> = ({ image, title, rating, price, originalPrice, discount }) => {
    return (
      ...
      <div className='w-[172px] h-[174px] mr-4 rounded-[13.42px] md:w-[295px] md:h-[298px] absolut md:rounded-[20px]  bg-[#F0EEED]'>
        <Image src={image} alt={title} className=" md:w-[295px] md:h-[298px] w-[172px] h-[174px]"/>
